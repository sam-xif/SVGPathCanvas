...
class PathCanvas extends Component {
  ...
  getCoordsRelativeToSVG(e) {
    const offsetX = e.target.clientLeft
    const offsetY = e.target.clientTop
  ...
  handleOnMouseUp(e) {
    ...
    if (onPathFinish) {
      onPathFinish() // TODO: Pass parameters here as necessary
    }
  }
  ...
  handleOnMouseMove(e) {
    ...
    const threshold = 40 // adjust as necessary
